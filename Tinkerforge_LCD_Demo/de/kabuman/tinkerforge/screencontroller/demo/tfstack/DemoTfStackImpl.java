...
public class DemoTfStackImpl extends TfAbstractStack implements TfStack{
	 ...
	 */
	public DemoTfStackImpl(TfStackCallbackApp tfCallback) {
		super(tfCallback);
	}
	...
	public void tfDeviceReConnected(TfDeviceInfo tfDeviceInfo) {
		...
		case BrickletVoltageCurrent.DEVICE_IDENTIFIER:
			tfVoltageCurrent = new BrickletVoltageCurrent(tfDeviceInfo.getUid(), tfDeviceInfo.getIpcon());
			break;
...
//		tfDeviceInfo.println();
	...
	public BrickletVoltageCurrent getTfVoltageCurrent() {
		return tfVoltageCurrent;
	}
