...
public class LogControllerImpl implements LogController {
	...
	/* (non-Javadoc)
	 * @see de.kabuman.tinkerforge.alarm.controller.LogController#createUserLogMessage(java.lang.String, java.lang.String, int)
	 */
	...
	/* (non-Javadoc)
	 * @see de.kabuman.tinkerforge.alarm.controller.LogController#createUserLogMessage(short, java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see de.kabuman.tinkerforge.alarm.controller.LogController#createTechnicalLogMessage(java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see de.kabuman.tinkerforge.alarm.controller.LogController#createTemperatureLogMessage(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see de.kabuman.tinkerforge.alarm.controller.LogController#createHumidityLogMessage(java.lang.String)
	 */
	...
	public void createLogMessageList() {
		...
		logMessageList.put(MSG_RESET_PRESSED, new LogMessage("Reset Taster länger als 2 Sekunden gedrückt!",
				MSG_ERROR));
		logMessageList.put(MSG_FIRE_VOLTAGE, new LogMessage(
				"Rauchmelder ohne Strom!", MSG_ALERT));
	}
