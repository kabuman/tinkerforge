 ...
 *  <br>
 * This thread triggers the pressed duration  <br>
 * up to the screen manager.  <br>
 *  <br>
 * So it must implement the Interface ItemsourceToPush
 */
public class RotaryEncoderPressedDurationSource extends Thread  implements ItemSourceToPush, RotaryEncoderConsumer{

	// the screen item value to push
	private long pressedDuration = 0;
	 ...
	 */
	public RotaryEncoderPressedDurationSource(BrickletRotaryEncoder tfRotaryEncoder) {
