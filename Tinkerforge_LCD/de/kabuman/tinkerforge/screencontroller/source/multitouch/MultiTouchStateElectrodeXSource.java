 ...
 */
public class MultiTouchStateElectrodeXSource extends Thread  implements ItemSourceToPush, MultiTouchConsumer{
	 ...
	 */
	public MultiTouchStateElectrodeXSource(BrickletMultiTouch tfMultiTouch, int bitNo) {
	...
	public Object getItemValue() {
		if (IOService.isSwitchedON(bitNo, state)){
			return bitNo+"=ON ";
		} else {
			return bitNo+"=OFF";
		} 
